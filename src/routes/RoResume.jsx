...
const experiencias = [
	{
		...
		bullets: [
			...
			[
				[
					"Desarrollo de herramientas de automatización para diseño basado en Figma, logrando una reducción del 90% en los tiempos de diseño.",
					"Development of automation tools for design based on Figma, achieving a 90% reduction in design times.",
				],
				[
					"Actualización de sistemas de diseño y kits de interfaz de usuario (UI Kits) con nuevas tecnologías, como variables en Figma.",
					"Update of design systems and user interface kits (UI Kits) with new technologies, such as variables in Figma.",
				],
				[
					"Creación de archivos de diseño para equipos de desarrollo en iOS, Android y web.",
					"Creation of design files for development teams in iOS, Android and web.",
...
const proyectos = [
	{
		...
		ubicacion: ["Ciudad de México", "Mexico City"],
		fecha: ["oct 2023 - Actualidad", "oct 2023 - Present"],
		bullets: [
			[
				[
					"Gestión de equipos de diseño para la creación de un libro web animado e interactivo sobre animales mitológicos mexicanos.",
					"Management of design teams for the creation of an animated and interactive web book about Mexican mythological animals.",
				],
				[
					"Diseño y desarrollo del sitio utilizando React, JS y Figma.",
					"Design and development of the site using React, JS and Figma.",
				],
			],
			[
				[
	...
	{
		empresa: "UAM Azcapotzalco",
		rol: ["Desarrollador UX/UI", "UX/UI Developer"],
		ubicacion: ["Ciudad de México", "Mexico City"],
		fecha: ["may 2022 - Actualidad", "may 2022 - Present"],
		bullets: [
			[
				[
					"Diseño y desarrollo de un sitio web de visualización de datos sobre el fenómeno del ruido en la Ciudad de México y el Área Metropolitana.",
					"Design and development of a data visualization website on the phenomenon of noise in Mexico City and the Metropolitan Area.",
				],
				[
					"Desarrollado utilizando JS, Processing y SASS, con repositorios alojados en GitHub.",
					"Developed using JS, Processing and SASS, with repositories hosted on GitHub.",
				],
			],
			[
				[
	...
	{
		empresa: "Hultz Price at UAM",
		rol: ["Comité y experto en UX/UI", "Committee and UX/UI expert"],
		ubicacion: ["Ciudad de México", "Mexico City"],
		fecha: ["ene 2022 - jun 2023", "jan 2022 - jun 2023"],
		bullets: [
			[
				[
					"Participación en el comité organizador, diseñando banners, videos y recursos gráficos.",
					"Participation in the organizing committee, designing banners, videos and graphic resources.",
				],
				[
					"Expositor en temas de UI/UX y branding.",
					"Speaker on UI/UX and branding topics.",
				],
			],
			[
				[
...
const CoCardResume = ({ experiencia }) => {
	...
	return (
		<div className="resume__sheet-content__body-card-experiencia">
			<h4>
				{experiencia.empresa} -{" "}
				{language == "ES" ? experiencia.rol[0] : experiencia.rol[1]}
			</h4>
			<span className="resume__sheet-content__body-card-experiencia__ubicacion">
				{experiencia.ubicacion[language == "ES" ? 0 : 1]} |{" "}
				{experiencia.fecha[language == "ES" ? 0 : 1]}
			</span>
			<ul>
				{experiencia.bullets[filtroResumen].map((bullet, index) => (
					<li key={index}>{bullet[language == "ES" ? 0 : 1]}</li>
				))}
				<ul>
					{experiencia.subbullets &&
						experiencia.subbullets.map((subbullet, index) => (
							<li key={index}>{subbullet[language == "ES" ? 0 : 1]}</li>
						))}
				</ul>
			</ul>
		</div>
